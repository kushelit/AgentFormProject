...
export type MicrosoftBookingsSetupState = {
  connected: boolean;
  ready: boolean;
  bookingBusinessId: string | null;
  bookingBusinessName: string | null;
...
type Props = {
  ...
  compact?: boolean;
  onStateChange?: (
    state: MicrosoftBookingsSetupState
  ) => void;
};

export default function MicrosoftBookingsSetup({
  agentId,
  compact = false,
  onStateChange,
}: Props) {
    ...
    <div
      ...
      className={
        compact
          ...
          : "mx-auto max-w-5xl space-y-6 p-6 text-right"
      }
    >
      {!compact ? (
