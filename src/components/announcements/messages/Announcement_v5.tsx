    ...
    <div className="announcement-overlay">
      <div className="announcement-box">
        ...
        <ul>
          ...
          <li>💸 <strong>יכולת  חדשה לניהול פיצולי עמלות</strong> – כעת ניתן להגדיר פיצול עמלות מול מקור ליד קיים ישירות מדף ניהול העמלות.  
            בדף המרכז ובדוח לקוח (במסך ניהול לקוחות) ניתן לראות את נתוני העמלות כולל השוואה בין עם וללא פיצול.</li>
        </ul>
