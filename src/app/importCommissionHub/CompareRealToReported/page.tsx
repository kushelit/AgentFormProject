// components/pages/CompareRealToReportedPage.tsx
'use client';
...
import CompareRealToReported from './CompareRealToReported';
...
const CompareRealToReportedPage = () => {
  ...
  return (
    <Suspense fallback={<div>Loading...</div>}>
      <CompareRealToReported />
    </Suspense>
  );
};

export default CompareRealToReportedPage;
