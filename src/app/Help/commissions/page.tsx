...
const CommissionsHelp = () => {
  return (
    <div className="help-container">
      ...
      <h2>📊 עמידה ביעדים</h2>
      <p>עמוד זה מציג את סטטוס עמידה ביעדים של כל עובד בסוכנות.</p>
      <ul>
      ...
      <Image src="/static/img/goals.png" alt="סטטוס יעדים" width={800} height={400} />

      <h2>📑 ניהול עסקאות</h2>
      <p>העמוד מציג רשימת עסקאות קיימות וכולל אפשרויות:</p>
      <ul>
